...
namespace ImGui {
    ...
    void
        ...
        if (drawFrameLines) {
            ...
            int32_t counter = 0;
            uint32_t primaryFrames = Pow10(counter++);
            uint32_t secondaryFrames = Pow10(counter);
            ...
            {
                primaryFrames = Pow10(counter++);
                secondaryFrames = Pow10(counter);
